...
user_agent_ = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6167.85 Safari/537.36"
headers_ = {
...
html_tables = parsed_html.find_all('table')
...
for element_th in first_launch_table.find_all('th'):
    name = extract_column_from_header(element_th)
   ...
   # get table row 
    for rows in table.find_all("tr"):
        ...
        if flag:
            ...
            if row[6] is not None and row[6].a is not None:
